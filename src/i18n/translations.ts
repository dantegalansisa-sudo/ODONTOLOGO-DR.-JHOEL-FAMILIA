...
export const translations: Record<Lang, Record<string, string>> = {
  es: {
    ...
    // Hero
    'hero.tagline': 'Diseño de Sonrisas',
    'hero.title1': 'TU',
    'hero.title2': 'SONRISA',
    ...
    // Footer
    'footer.tagline': 'Diseño de Sonrisas',
    'footer.rights': '© 2026 Dr. Jhoel Familia. Todos los derechos reservados.',
  ...
  en: {
    ...
    // Footer
    'footer.tagline': 'Smile Design',
    'footer.rights': '© 2026 Dr. Jhoel Familia. All rights reserved.',
