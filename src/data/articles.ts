...
export const articles: Article[] = [
  {
    ...
    readTime: '4 min',
    img: '/imagenes/drjhoel/blog-estetica.png',
    content: [
      ...
      'En Dr. Jhoel Familia evaluamos cada caso de forma personalizada. Durante tu consulta, analizaremos el estado de tus dientes, tus expectativas y tu presupuesto para recomendarte el tratamiento que mejor se adapte a ti.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '5 min',
    img: '/imagenes/drjhoel/blog-implantes.png',
    content: [
      ...
      'En Dr. Jhoel Familia utilizamos tecnología de diagnóstico 3D para planificar cada implante con precisión milimétrica, asegurando los mejores resultados posibles para cada paciente.',
    ],
    tips: [
  ...
  },
  {
    ...
    readTime: '3 min',
    img: '/imagenes/drjhoel/blog-prevencion.png',
    content: [
      ...
      'En Dr. Jhoel Familia creemos que la prevención es la mejor inversión en tu salud dental. Nuestro equipo está disponible para enseñarte las técnicas correctas y crear un plan de prevención personalizado.',
    ],
    tips: [
