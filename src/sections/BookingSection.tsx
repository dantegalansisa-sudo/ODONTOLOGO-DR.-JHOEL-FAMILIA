...
const infoItems = [
  ...
  { icon: '📞', label: 'Teléfono', value: '(829) 794-4272' },
  { icon: '⏰', label: 'Horario', value: 'Lun - Vie: 9:00 AM - 6:00 PM | Sáb: 9:00 AM - 2:00 PM' },
  { icon: '💬', label: 'WhatsApp', value: '(829) 794-4272' },
  { icon: '✉️', label: 'Instagram', value: '@dr.jhoelfamilia' },
];
    ...
    <div className="booking-cal__root">
      ...
      {selectedDay && selectedTime && (
        <motion.button
          ...
          onClick={() =>
            window.open(
              `https://wa.me/18297944272?text=Hola, quiero agendar una cita el ${selectedDay} de ${MONTH_NAMES[month]} a las ${selectedTime}.`,
              '_blank',
            )
          }
        >
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    window.open(`https://wa.me/18297944272?text=${text}`, '_blank');
    setSent(true);
