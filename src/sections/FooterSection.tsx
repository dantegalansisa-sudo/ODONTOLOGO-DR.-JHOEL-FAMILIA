  ...
  return (
    <footer className="footer">
      <div className="section-container">
        ...
        >
          <div>
            <div className="footer__logo">DR. JHOEL FAMILIA</div>
          ...
          <div className="footer__social">
            <a href="https://instagram.com/dr.jhoelfamilia" target="_blank" rel="noopener noreferrer" className="footer__social-link interactive" aria-label="Instagram">
