  ...
  return (
    <section className="hero">
      ...
      <div className="hero__content">
        ...
        >
          <span className="hero__brand-name">Dr. Jhoel</span>
          <span className="hero__brand-name hero__brand-name--accent">Familia</span>
        </motion.div>
        ...
        >
          <div className="data-point">
            <span className="data-number">+3,000</span>
